package by.railway.schedule.data.mapper

import android.util.Log
import by.railway.schedule.domain.models.response.ErrorModel
import by.railway.schedule.domain.models.response.ErrorStatus
...
class CloudErrorMapper @Inject constructor(private val gson: Gson) {
    ...
    fun mapToDomainErrorException(throwable: Throwable?): ErrorModel {
        ...
        return ErrorModel("CHECK CONNECTION",0,ErrorStatus.NO_CONNECTION)
    }
